def credit(dataset="data"):
    ...
    #scale all the dataset to achieve better accuracy
    ...
    def other(y_test):
        ...
        pred3=dtree.predict(X_test).astype(dtype='int64')
        ...
        rfc.fit(X_train, y_train)
        pred5=rfc.predict(X_test).astype(dtype='int64')
